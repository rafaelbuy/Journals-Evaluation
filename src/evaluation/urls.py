...
from evaluation.evaluations.views import index, user_logout, user_login
...
urlpatterns = patterns('',
    ...
    url(r'^$', index, name="evaluation.evaluations.index"),

    # Evaluation application
    url(r'^evaluation/', include('evaluation.evaluations.urls')),

    url(r'^accounts/logout/$', user_logout, name='evaluations.user_logout'),

    url(r'^accounts/login/$', user_login, name='evaluations.user_login'),
